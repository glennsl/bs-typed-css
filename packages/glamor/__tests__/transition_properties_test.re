...
describe("transitionDelay", () => {
  testDeclaration(transitionDelay(unset), ("transitionDelay", "unset"));
  testDeclaration(transitionDelay(ms(100)), ("transitionDelay", "100ms"));
...
describe("transition", () => {
  testDeclaration(transition(unset), ("transition", "unset"));
  testDeclaration(transition(none), ("transition", "none"));
  ...
  testDeclaration(transitions([]), ("transition", "none"));
});